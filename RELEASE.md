...
- **proxy_checker.py** — команда `/check tg://proxy?...` для полной диагностики узла
- DNS резолв, TCP прокси, SSH (22), Ping (ICMP), MTProto
- Формат вывода как на скриншоте: Resolved IPs, статусы по каждому протоколу, диагностика, время проверки
