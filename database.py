...
# БД рядом со скриптом, а не в рабочем каталоге (при init.d.cwd может меняться)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DB_PATH = os.environ.get("TELEMT_BOT_DB_PATH", os.path.join(BASE_DIR, "telemt_bot.db"))
